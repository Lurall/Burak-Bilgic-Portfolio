        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ opacity: scrolled ? 0.4 : 0.7 }}>
                <svg viewBox="0 0 1440 80" className="absolute bottom-0 left-0 w-full h-full" preserveAspectRatio="none" fill="none">
                    {/* Cloud group 1 - left, wide and low */}
                    ...
                    {/* Cloud group 2 - center-left, tall and puffy */}
                    ...
                    {/* Cloud group 3 - center, large irregular */}
                    ...
                    {/* Cloud group 4 - center-right, small scattered */}
                    ...
                    {/* Cloud group 5 - right, elongated wispy */}
            ...
            {mobileOpen && (
                <div
                    className="md:hidden px-10 pb-8 pt-6 flex flex-col gap-5"
